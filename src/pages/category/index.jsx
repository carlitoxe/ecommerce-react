...
<input
        ...
        className="block w-full px-4 ps-10 py-1.5 pl-5 border rounded-lg bg-transparent border-gray-300 placeholder-gray-400  text-white focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-700 mb-2"
        value={searchValue} 
